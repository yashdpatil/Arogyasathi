...
//	} 
	...
	@PutMapping("/patient/appointment/updateDate/{appointmentId}")
	...
	@DeleteMapping("/patient/appointment/delete/{appointmentId}")
	...
	@PutMapping("/doctor/accept/{appointmentId}")
    ...
    @PutMapping("/doctor/reject/{appointmentId}")
